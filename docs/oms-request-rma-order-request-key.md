...
> **종결(2026-09-14).** OMS가 `e6e6a35`(PR #10)로 반영했고, system-tests 기준 커밋도 올라갔다(PR #9).
> WMS는 `orderRequestKey`를 필수로 바꾸고 레거시 경로를 지웠다. 아래는 요청 당시 기록이다.

**요청일** 2026-09-09 · **WMS 쪽 상태** **master 병합 완료**(PR #37, Java 512건 통과) — 지금 보내셔도 받습니다
